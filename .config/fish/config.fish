# Forked from DistroTube. Tweaked some things.
#  ____ _____ 
...
set EDITOR "nano"      # $EDITOR use nano in terminal
set VISUAL "kate"   # $VISUAL use kate in GUI mode
...
alias gitdo="git add . && git commit -u && git push"
